...
<head>
	...
	<title>Realty: propiedades</title>
...
<body>
	<div class="cont">
		...
		<div class="menu-lateral">
			...
			<hr>
			<a id="viewp" href="#" class="btn btn-primary">Aplicar filtros</a>
		</div>
			...
			<div id="slider" class="carousel slide" data-bs-ride="carousel">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="img/img_top_1.jpg" class="d-block w-100" alt="">
					...
					<div class="carousel-item ">
						...
						<!-- texto en el principio -->
						<div id="text-portada-1" class="carousel-caption text-left">
							<h1>Alojamiento entero: residencia en Mazatlán, México</h1>
							<p>Más de 16 huéspedes - 3 habitaciones - 7 camas - 2 baños completos y uno de tocador</p>
							<p><a class="btn btn-lg btn-primary" id="boton-p1" href="#" role="button">Ver propiedad</a>
							</p>
					...
					<div class="carousel-item ">
						<img src="img/img_top_3.png" class="d-block w-100" alt="">
						<!-- texto en el principio -->
